...
namespace ShoesApi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230412163157_reinit_after_project_restructurize")]
    partial class reinit_after_project_restructurize
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoesApi.Domain.Entities.File", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ShoesApi.Domain.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ShoesApi.Domain.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ShoesApi.Domain.Entities.Shoe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ShoesApi.Domain.Entities.ShoeSimpleFilters.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ShoesApi.Domain.Entities.ShoeSimpleFilters.Destination", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ShoesApi.Domain.Entities.ShoeSimpleFilters.Season", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ShoesApi.Domain.Entities.Size", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ShoesApi.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ShoesApi.Domain.Entities.Order", b =>
                {
                    b.HasOne("ShoesApi.Domain.Entities.User", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ShoesApi.Domain.Entities.OrderItem", b =>
                {
                    b.HasOne("ShoesApi.Domain.Entities.Order", "Order")
                        .WithMany("OrderItems")
                    ...
                    b.HasOne("ShoesApi.Domain.Entities.Shoe", "Shoe")
                        .WithMany("OrderItems")
                    ...
                    b.HasOne("ShoesApi.Domain.Entities.Size", "Size")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("ShoesApi.Domain.Entities.Shoe", b =>
                {
                    b.HasOne("ShoesApi.Domain.Entities.ShoeSimpleFilters.Brand", "Brand")
                        .WithMany("Shoes")
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .HasConstraintName("fk_shoes_brands_brand_id");

                    b.HasOne("ShoesApi.Domain.Entities.ShoeSimpleFilters.Destination", "Destination")
                        .WithMany("Shoes")
                        .HasForeignKey("DestinationId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .HasConstraintName("fk_shoes_destinations_destination_id");

                    b.HasOne("ShoesApi.Domain.Entities.File", "ImageFile")
                        .WithMany("Shoes")
                    ...
                    b.HasOne("ShoesApi.Domain.Entities.ShoeSimpleFilters.Season", "Season")
                        .WithMany("Shoes")
            ...
            modelBuilder.Entity("ShoeSize", b =>
                {
                    b.HasOne("ShoesApi.Domain.Entities.Shoe", null)
                        .WithMany()
                    ...
                    b.HasOne("ShoesApi.Domain.Entities.Size", null)
                        .WithMany()
